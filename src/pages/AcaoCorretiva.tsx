...
export default function AcaoCorretiva() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Ação corretiva criada com sucesso!",
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold">Nova Ação Corretiva</h1>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Informações da Ação Corretiva</CardTitle>
            </CardHeader>
